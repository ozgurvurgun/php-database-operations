        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card mt-3 bg-light">
                    <div class="card-body">
                        <form method="POST" id="AddMemberForm2" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2"></div>
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-success btn-lg" id="SaveButton" name="SaveButton" onclick="FillForm('AddMemberForm2','SaveMember')">Kaydet <span class="loadingAnimation"></span></button>
                                </div>
                            </div>
                        </form>
                    </div>
