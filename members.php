                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputUsername" name="MemberUsername" maxlength="40">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputLastname" name="MemberLastname">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="inputBorn" name="MemberBorn">
                                </div>
                            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            echo '<div class="alert alert-success mt-4">Toplam kayıtlı üye sayısı: ' . $records . '</div>';
                            ...
                            foreach ($query as $items) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="delete.php?ID=<?= $items->MemberID ?>">
